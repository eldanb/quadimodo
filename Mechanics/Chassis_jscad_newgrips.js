const motorRadius = 3.8;
const gearBoxRadius = 4.8;
const gearBoxNotchSize = 2;
const motorHolderGapSize = 1;
const motorHolderWallThick = 1.5;
const motorHolderHeight = 10;

const chassisLen = 175;
const chassisWidth = 6;
const chassisThick = 3;
...
function gearedMotorHolder() {
    return tube(
				   ...
				   tube(
				      ...
				      CSG.cube({ corner1: [motorRadius-0.1, -motorHolderGapSize/2, motorHolderHeight/2],
									   corner2: [motorRadius + motorHolderWallThick + 0.5, motorHolderGapSize/2,-3]
									})			         
				   ))
